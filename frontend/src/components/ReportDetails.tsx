      ...
      <table className="w-full text-sm border border-gray-200 rounded overflow-y-auto custom-scroll ">
        ...
        <tbody className="divide-y divide-gray-200">
          ...
          <tr>
            ...
            <td
              className={`p-3 ${
                !report.openRedirects.found ? "text-green-500" : "text-red-500"
              }`}
            >
            ...
            <td className="p-3 text-slate-500">
              {report.securityHeaders.missing.length > 0 ? (
                <ul className="list-disc list-inside text-red-600">
                  {report.securityHeaders.missing.map((item: any, idx: any) => (
                    <li key={idx}>{item}</li>
                  ))}
                </ul>
              ) : (
          ...
          <tr>
            ...
            <td
              className={`p-3 ${
                !report.hiddenScripts.found ? "text-green-500" : "text-red-500"
              }`}
            >
          ...
          <tr>
            ...
            <td
              className={`p-3 ${
                !report.dnsRebinding.found ? "text-green-500" : "text-red-500"
              }`}
            >
