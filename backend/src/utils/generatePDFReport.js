...
export const generatePDFReport = async (url, scanResults) => {
  ...
  const outputPath = path.join('reports', `CyberCage-web_Report_${Date.now()}.pdf`);
  ...
  doc
    ...
    .fontSize(22)
    .font('Helvetica-Bold')
    .text('CyberCage-web - Website Security Report', { align: 'center' })
    .moveDown(0.3)
    .fontSize(12)
    .fillColor('#37474f')
    .font('Helvetica')
  ...
  doc
    ...
    .fontSize(9)
    .fillColor('gray')
    .text('Report generated by CyberCage-web - Open Source Security Scanner', {
      align: 'center'
    })
    .text('© 2025 CyberCage-web Team. All rights reserved.', {
      align: 'center'
    });
